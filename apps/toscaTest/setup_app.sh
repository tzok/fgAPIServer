...
CURLDATA="'{\"infrastructures\": [{\"description\": \"$APPDESC\",\"parameters\": [{\"name\": \"tosca_endpoint\",\"value\": \"tosca://90.147.170.152:80/orchestrator/deployments\"},{\"name\": \"tosca_token\",\"value\": \"11223344556677889900AABBCCDDEEFF\"},{\"name\": \"tosca_template\",\"value\": \"tosca_template.yaml\"},{\"name\": \"tosca_parameters\",\"value\": \"wait_ms=30000&max_waits=30\"}],\"enabled\": true,\"virtual\": false,\"name\": \"$INFRANAME\"}],\"parameters\": [{\"name\": \"target_executor\",\"value\": \"SimpleTosca\",\"description\": \"\"},{\"name\": \"jobdesc_executable\",\"value\": \"tosca_test.sh\",\"description\": \"\"},{\"name\": \"jobdesc_output\",\"value\": \"stdout.txt\",\"description\": \"\"},{\"name\": \"jobdesc_error\",\"value\": \"stderr.txt\",\"description\": \"\"}],\"enabled\": true,\"input_files\": [{\"override\": false,\"path\": \"$FILESPATH\",\"name\": \"tosca_template.yaml\"},{\"override\": false,\"path\": \"$FILESPATH\",\"name\": \"tosca_test.sh\"}],\"name\": \"$APPNAME\",\"description\": \"$APPDESC\"}'"

# Setup application, retrieve id and sets stress_test app_id
TMP=$(mktemp)
CMD="curl -i -H \"Content-Type: application/json\" -X POST -d $CURLDATA http://localhost:8888/v1.0/applications?user=$USER" | tee $TMP
# echo $CMD
eval $CMD
